...
[![CRAN status](https://www.r-pkg.org/badges/version/agrobox)](https://CRAN.R-project.org/package=agrobox)
[![CRAN downloads](https://cranlogs.r-pkg.org/badges/grand-total/agrobox)](https://CRAN.R-project.org/package=agrobox)
...
> **How do I turn my experimental data into a statistical result — and, more importantly, into a decision?**
...
The function automatically evaluates the statistical assumptions and selects the appropriate analysis path:
...
**Robust analysis** (when variance homogeneity is not supported)
- Welch ANOVA
...
- Statistical power
- Means, grouping letters, and significance annotations
...
Agricultural experiments frequently involve more than one factor (e.g., Variety × Treatment, Treatment × Location).
...
A single experiment rarely measures only one variable. You might record yield, fruit weight, firmness, color, soluble solids, acidity, incidence, severity — and more.
...
Particularly useful when an experiment contains several variables — results are organized into worksheets, eliminating manual copy-paste from R to Excel.
...
If you find yourself thinking *"I wish agrobox could do this..."* — please tell me.

- 💡 [Suggest a feature](https://github.com/Joa3aquin50/agrobox/issues)
- 🐛 [Report a bug](https://github.com/Joa3aquin50/agrobox/issues)
- 💬 [Start a discussion](https://github.com/Joa3aquin50/agrobox/discussions)
...
Interests: agricultural experimentation · statistical analysis · postharvest research · reproducible research · R programming
...
> 🌾 *From experiment to decision — let's make agricultural statistics more accessible.*
